...
public class SampleController {
    ...
    // 반환형이 String 일 떄 브라우저에 String 자체가 출력
    @GetMapping("/hello")
    public String getHello() {
        return "Hello, World";
    }

    // 반환형이 String[] 일 때는 자동으로 json 형식을 가지고 출력
    @GetMapping("/hello2")
    ...
    public List<SampleVO> getHello4() {
      ...
      public DataVO getHello5(String number) {
          ...
          SampleVO svo2 =new SampleVO("홍길동" , "100");
          SampleVO svo3 =new SampleVO("희동이","3");    
      ...
      @PostMapping("/hi4")
      // 요청자체가 json 방식일때
      public String[] getHi4(@RequestBody Map<String,String> idx) {
          return new String[] {"Hello","World "};
      }
